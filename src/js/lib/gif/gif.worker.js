(function() {
    var worker = function() {
        (function(b) {
            ...
            a.modules = {}, a.cache = {}, a.resolve = function(b) {
            ...
            }), a.define('/GIFEncoder.js', function(e, k, i, j) {
                function c() {
                    this.page = -1, this.pages = [], this.newPage()
                }

                function b(a, b) {
                    this.width = ~~a, this.height = ~~b, this.transparent = null, this.transIndex = 0, this.repeat = -1, this.delay = 0, this.image = null, this.pixels = null, this.indexedPixels = null, this.colorDepth = null, this.colorTab = null, this.usedEntry = new Array, this.palSize = 7, this.dispose = -1, this.firstFrame = !0, this.sample = 10, this.preserveColors = !1, this.out = new c
                }
                var f = a('/TypedNeuQuant.js', e),
                    g = a('/SimpleQuant.js', e),
                    h = a('/LZWEncoder.js', e);
                ...
                c.prototype.newPage = function() {
                    ...
                    if (this.transparent) {
                      tComponents = [
                        (this.transparent & 16711680) >> 16,
                        (this.transparent & 65280) >> 8,
                        this.transparent & 255
                      ];
                    }
                    this.preserveColors ? a = new g(this.pixels, this.sample, tComponents) : a = new f(this.pixels, this.sample), a.buildColormap(), this.colorTab = a.getColormap();
                    var b = 0;
                    for (var c = 0; c < d; c++) {
                    ...
                    var a = new h(this.width, this.height, this.indexedPixels, this.colorDepth);
                    a.encode(this.out)
                ...
                e.exports = f
            }), a.define('/SimpleQuant.js', function(b, d, e, f) {
                function a(a, b, c) {
                    return [a, b, c].join('.')
                }

                function c(b,sample,t) {
                    this.pixels = b, this.palette = [], this.paletteIndex = {}, this.getColormap = function() {
                        return this.palette
                    }, this.buildColormap = function() {
                        var h = this.pixels.length / 3,
                            b = 0;
                        for (var c = 0; c < h; c++) {
                            var d = this.pixels[b++],
                                e = this.pixels[b++],
                                f = this.pixels[b++],
                                g = a(d, e, f);
                            this.paletteIndex.hasOwnProperty(g) || (this.palette.push(d), this.palette.push(e), this.palette.push(f), this.paletteIndex[g] = this.palette.length / 3 - 1)
                        }
                        if (t) {
                          var transparentKey = a(t[0], t[1], t[2]);
                          this.paletteIndex.hasOwnProperty(transparentKey) || (this.palette.push(t[0]), this.palette.push(t[1]), this.palette.push(t[2]), this.paletteIndex[transparentKey] = this.palette.length / 3 - 1)
                        }
                    }, this.lookupRGB = function(b, c, d) {
                        return this.paletteIndex[a(b, c, d)]
                    }
                }
                b.exports = c
