(function () {
  ...
  ns.PreviewActionsController.prototype.init = function () {
    ...
    $.subscribe(
      ...
      this.updatePreviewSizeButtons_.bind(this)
    );
    $.subscribe(
  ...
  ns.PreviewActionsController.prototype.disablePreviewSizeWidget_ = function (
    reason
  ) {
    // The .preview-disable-overlay is displayed on top of the preview size widget
    document
      .querySelector(".preview-disable-overlay")
      .setAttribute("data-original-title", reason);
  ...
  ns.PreviewActionsController.prototype.onUserSettingsChange_ = function (
    evt,
    name,
    value
  ) {
